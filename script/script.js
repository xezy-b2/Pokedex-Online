...
compHtml = `<div class="is-companion">
    ...
    <div style="width:100%; background:rgba(255,255,255,0.1); border-radius:999px; height:8px; margin-top:6px; overflow:hidden;">
    ...
    <p style="font-size:0.7em; color:var(--text-secondary); margin:3px 0 0 0;">${cp.xp} / ${cp.level * 100} XP</p>
</div>`;
        }
